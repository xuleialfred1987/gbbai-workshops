...
import type { ResizeHandle } from './screen-recording-container-types';
import { MIN_WIDTH, MIN_HEIGHT, DEFAULT_SIZE, DEFAULT_POSITION } from './screen-recording-container-types';
